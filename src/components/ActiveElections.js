/*
* @Author: nikunjb
* @Date:   2016-05-20 16:38:22
* @Last Modified by:   NikunjB
* @Last Modified time: 2016-05-23 14:45:56
*/
...
function mapStateToProps(state) {
    return {
        data: state.activeElections.data
    };
}
...
class ActiveElections extends Component {
    ...
    render () {
        var custodians = this.props.data;
        return (
            <Table
                rowHeight={50}
                ...
                <ColumnGroup
                    ...
                    />
                    <Column
                      header={<Cell className="customStyle">Col 3</Cell>}
                      flexGrow={1}
                      cell={({rowIndex}) => {
                        if(custodians[rowIndex] != undefined) {
                            return (
...
export default connect(mapStateToProps, mapDispatchToProps)(ActiveElections);
